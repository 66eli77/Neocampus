...
public class SpriteShaderProgram extends ShaderProgram{
    ...
    public SpriteShaderProgram(Context context) {
        super(context, R.raw.sprite_vertex_shader,
            R.raw.sprite_fragment_shader);
    ...
    public void setUniforms(float[] matrix, float[] textureMatrix, int textureId) {
